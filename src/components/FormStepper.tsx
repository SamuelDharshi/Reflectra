                ...
                <div className="flex flex-col items-center relative">
                  <motion.div 
                    className={cn(
                      ...
                      isActive
                        ? "border-amber-500 bg-gradient-to-r from-amber-500 to-rose-400 text-white shadow-lg shadow-amber-500/25"
                        : isCompleted
                          ? "border-emerald-500 bg-gradient-to-r from-emerald-500 to-green-600 text-white shadow-lg shadow-emerald-500/25"
                          : isUpcoming
                  ...
                  {isActive && (
                    <motion.div
                      ...
                      className="absolute -bottom-2 w-2 h-2 bg-amber-500 rounded-full"
                    />
                  )}
                </div>
      ...
      <div className="block lg:hidden">
        <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl p-6 border border-slate-200/50 dark:border-slate-700/50 shadow-lg">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-r from-amber-500 to-rose-400 flex items-center justify-center text-white font-bold shadow-lg shadow-amber-500/25">
              {currentStepIndex + 1}
            </div>
          </div>
